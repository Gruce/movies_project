<div>
    <div class="w-60 h-80  bg-cover flex items-end justify-center  rounded-lg shadow-md relative group transition ease-in-out duration-300"
        style="background-image: url('https://i.ytimg.com/vi/N2YTmooNR8E/maxresdefault.jpg')">
        ...
        <div class="z-10 -mb-3 text-center group-hover:mb-5 group-hover:duration-300 ">
            <h1 class="text-white text-x1 font-semibold tracking-tight">Avengers</h1>
            <div class="flex items-center flex-col mt-1 mb-2 shadow-md">
                <div class="flex" >
                ...
                <x-ui.button color="error" class="mt-3 invisible opacity-0 group-hover:opacity-100 group-hover:visible group-hover:duration-300 ">
                    <a href="{{route("show")}}"> Watch Now </a>
                </x-ui.button>
            </div>
        </div>
    </div>
