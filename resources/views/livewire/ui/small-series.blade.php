<div href="#" class="bg-white rounded-lg p-2 flex mt-2 hover:bg-gray-100 group transition ease-in-out duration-300">
    <img class="rounded-lg h-28 basis-1/3 w-20" src="{{ $episode->cover_url }}" />
