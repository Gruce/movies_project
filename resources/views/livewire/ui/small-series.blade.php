<div href="#" class="bg-white rounded-lg p-2 flex mt-3 hover:scale-105 hover:bg-gray-100 group transition ease-in-out duration-300">
    <img class="rounded-lg h-28 basis-1/3 w-1/3" src="{{ $episode->cover_url }}" />
