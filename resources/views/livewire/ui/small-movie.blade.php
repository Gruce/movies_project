<div wire:loading.class="opacity-50" href="#" class="bg-white hover:scale-105 rounded-lg p-2 flex mt-3 hover:bg-gray-100 group transition ease-in-out duration-300">
