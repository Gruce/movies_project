    ...
    <div class="overflow-y-auto h-screen py-4 px-3 bg-black  ">
        <ul class="space-y-2">
            <li>
                ...
                <svg class="w-6 h-6 text-white transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
        ...
        <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-base font-normal text-white rounded-lg transition duration-75 ">
