<nav class="bg-gray-800 border-gray-200 px-2 sm:px-4 py-2.5 " >
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex md:order-2">
            <div class="hidden relative mr-3 md:mr-0 md:block">
                ...
                <input type="text" id="email-adress-icon" class="block p-2 pl-10 w-full text-gray-500 bg-gray-700 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
            </div>
    ...
    {{-- <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
        ...
        <li>
            <a href="#" class="block py-2 pr-4 pl-3 text-white border-b border-gray-200 hover:bg-gray-200 md:hover:bg-transparent md:border-0 md:hover:text-gray-100 md:p-0 ">About</a>
        </li>
        <li>
            <a href="#" class="block py-2 pr-4 pl-3 text-white border-b border-gray-200 hover:bg-gray-200 md:hover:bg-transparent md:border-0 md:hover:text-gray-100 md:p-0 ">Services</a>
        </li>
        </ul>
    </div> --}}
    </div>
